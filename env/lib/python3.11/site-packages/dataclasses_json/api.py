...
def _process_class(
    ...
    if letter_case is not None or undefined is not None:
        cls.dataclass_json_config = config(
            letter_case=letter_case, undefined=undefined  # type: ignore[attr-defined]
        )["dataclasses_json"]
    ...
    cls.__init__ = _handle_undefined_parameters_safe(
        cls, kvs=(), usage="init"  # type: ignore[attr-defined,method-assign]
    )
